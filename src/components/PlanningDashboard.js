              ...
              {dayBons.map((b) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    marginBottom: 5,
                    background: b.isRetouche ? "#fff8f4" : "var(--color-background-primary)",
                    border: "0.5px solid var(--color-border-tertiary)",
                    borderLeft: `4px solid ${
                      b.isRetouche ? "#E8845C" : (techColors[b.techNom] || "#35B499")
                    }`,
                  }}
                >
                  {/* Heure */}
                  ...
                  >
                    <span
                      style={{
                        fontSize: 13,
                        fontWeight: 800,
                        color: b.isRetouche ? "#E8845C" : (techColors[b.techNom] || "#35B499"),
                      }}
                    >
                      {b.heurePrevue || "—"}
                    </span>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:2}}>
                      ...
                      {b.isRetouche&&<span style={{fontSize:10,fontWeight:700,padding:"1px 7px",borderRadius:20,background:"#fdebd0",color:"#a04000",whiteSpace:"nowrap",flexShrink:0}}>🔧 Retouche</span>}
                    </div>
                    <div
                      style={{
                        display: "flex",
